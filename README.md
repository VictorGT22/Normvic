...
<div>
  <img style="float: left;" src="./bin/media/videos/howworks.gif" width="300" height="300">
  <img style="float: right;" src="./bin/media/videos/howworks_h.gif" width="300" height="300">
</div>
## INSTALL
