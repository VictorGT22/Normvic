...
<div>
  <img style="float: left;" src="./bin/media/videos/howworks.gif" width="500" height="500">
  <img style="float: right;" src="./bin/media/videos/howworks_h.gif" width="500" height="500">
</div>
## INSTALL
